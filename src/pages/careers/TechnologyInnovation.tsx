  ...
  const jobs: Job[] = [
    {
      ...
      description: 'Build scalable digital health solutions that transform healthcare delivery across Africa. Develop web and mobile applications for patient management, telemedicine, and health information systems. Work with modern tech stack including React, Node.js, and cloud infrastructure.',
    ...
    {
      id: '2',
      title: 'Data Analytics Manager - Health Insights',
      location: 'Cape Town, South Africa',
      country: 'South Africa',
      posted: 'Posted 3 days ago',
      description: 'Lead data analytics initiatives to drive evidence-based decision making in healthcare. Design and implement data pipelines, create actionable dashboards, and provide insights on health outcomes, supply chain optimization, and operational efficiency. Experience with SQL, Python, and BI tools required.',
      employmentType: 'Full-time',
      level: 'Mid-Level',
      tags: ['South Africa', 'Analytics']
    },
    {
      id: '3',
      title: 'Health IT Systems Architect',
      location: 'Lagos, Nigeria',
      country: 'Nigeria',
      posted: 'Posted 5 days ago',
      description: 'Design and implement enterprise health information technology architecture. Lead integration of electronic health records, pharmacy management systems, and interoperability solutions. Ensure HIPAA compliance, data security, and system scalability across multiple facilities.',
      employmentType: 'Full-time',
      level: 'Senior-Level',
      tags: ['Nigeria', 'Architecture']
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl leading-relaxed mb-12">
              Build the digital infrastructure powering healthcare transformation across Africa. Our 
              technology teams create innovative solutions that connect patients, providers, and health 
              systems at scale.
            </p>
