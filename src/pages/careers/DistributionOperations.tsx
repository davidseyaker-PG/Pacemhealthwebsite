...
export default function DistributionOperations() {
  ...
  const jobs: Job[] = [
    ...
    {
      id: '3',
      title: 'Logistics Coordinator - West Africa',
      location: 'Lagos, Nigeria',
      country: 'Nigeria',
      posted: 'Posted 1 week ago',
      description: 'Coordinate transportation and logistics operations across West Africa region. Plan routes, manage carrier relationships, track shipments, and optimize delivery schedules to ensure timely product distribution.',
      employmentType: 'Full-time',
      level: 'Entry-Level',
      tags: ['Nigeria', 'Multi-Country']
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl leading-relaxed mb-12">
              Build the backbone of healthcare access across Africa. Our distribution operations 
              ensure that essential medicines, equipment, and supplies reach communities that need 
              them most.
            </p>
