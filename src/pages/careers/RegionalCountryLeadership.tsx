...
export default function RegionalCountryLeadership() {
  ...
  const jobs: Job[] = [
    {
      ...
      description: 'Lead all Pacem Health operations in Nigeria, overseeing strategy development, business growth, stakeholder engagement, and operational excellence. Direct multidisciplinary teams across distribution, clinical services, and health systems advisory. Build partnerships with government, NGOs, and private sector organizations.',
      employmentType: 'Full-time',
      level: 'Executive',
      tags: ['Nigeria', 'Leadership']
    },
    {
      id: '2',
      ...
      description: 'Oversee regional operations across Kenya, Uganda, Tanzania, and Rwanda. Drive revenue growth, operational efficiency, and service delivery excellence. Lead country teams, develop regional strategies, and ensure alignment with corporate objectives. Extensive travel required across the region.',
      employmentType: 'Full-time',
      level: 'Senior-Level',
      tags: ['Kenya', 'Multi-Country']
    },
    {
      id: '3',
      title: 'Market Development Lead - Southern Africa',
      location: 'Johannesburg, South Africa',
      country: 'South Africa',
      posted: 'Posted 1 week ago',
      description: 'Identify and develop new market opportunities in Southern Africa including South Africa, Zimbabwe, Botswana, and Mozambique. Conduct market assessments, establish strategic partnerships, lead business development initiatives, and support entry into new countries and service areas.',
      employmentType: 'Full-time',
      level: 'Senior-Level',
      tags: ['South Africa', 'Business Development']
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h1 className="text-6xl lg:text-7xl font-serif font-extrabold leading-tight text-white mb-6">
              Regional & Country Leadership Careers
            </h1>
            <p className="text-xl text-white/90 max-w-3xl leading-relaxed mb-12">
              Lead healthcare transformation at scale. Our regional and country leaders drive strategic 
              growth, build partnerships, and shape the future of healthcare delivery across African markets.
            </p>
