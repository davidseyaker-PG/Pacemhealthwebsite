...
export default function ClinicalPharmacy() {
  ...
  const jobs: Job[] = [
    {
      id: '1',
      title: 'Clinical Pharmacist - Hospital Services',
      location: 'Kampala, Uganda',
      country: 'Uganda',
      posted: 'Posted 1 day ago',
      description: 'Provide clinical pharmacy services in hospital settings, including medication therapy management, patient counseling, and collaboration with healthcare teams. Ensure optimal medication use and patient safety while supporting chronic disease management programs.',
      employmentType: 'Full-time',
      level: 'Mid-Level',
      tags: ['Uganda', 'Clinical']
    },
    {
      id: '2',
      ...
      description: 'Oversee daily operations of community pharmacy network including inventory management, quality assurance, staff supervision, and regulatory compliance. Implement pharmacy best practices and ensure adherence to Good Pharmacy Practice (GPP) standards.',
      employmentType: 'Full-time',
      level: 'Senior-Level',
      tags: ['Tanzania', 'Management']
    },
    {
      id: '3',
      title: 'Clinical Advisor - Maternal & Child Health',
      location: 'Kigali, Rwanda',
      country: 'Rwanda',
      posted: 'Posted 1 week ago',
      description: 'Provide technical guidance and clinical oversight for maternal and child health programs. Develop clinical protocols, train healthcare workers, and support quality improvement initiatives in antenatal care, delivery services, and pediatric health.',
      employmentType: 'Full-time',
      level: 'Senior-Level',
      tags: ['Rwanda', 'MCH']
    }
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl leading-relaxed mb-12">
              Lead clinical excellence across Africa. Our pharmacists and clinical advisors ensure 
              quality medication therapy management, patient safety, and evidence-based pharmaceutical care.
            </p>
