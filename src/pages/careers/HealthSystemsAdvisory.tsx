...
export default function HealthSystemsAdvisory() {
  ...
  const jobs: Job[] = [
    {
      id: '1',
      title: 'Healthcare Systems Consultant - East Africa',
      location: 'Nairobi, Kenya',
      country: 'Kenya',
      posted: 'Posted 2 days ago',
      description: 'Provide strategic advisory services to strengthen healthcare systems across East Africa. Conduct health system assessments, develop capacity building plans, and support implementation of quality improvement initiatives. Work with government partners, NGOs, and healthcare facilities.',
    ...
    },
    {
      ...
      description: 'Support development and implementation of health policies and regulations. Conduct policy analysis, engage stakeholders, and provide technical guidance to government health agencies. Focus on pharmaceutical policy, health financing, and service delivery frameworks.',
      employmentType: 'Full-time',
      level: 'Senior-Level',
      tags: ['Nigeria', 'Policy']
    },
    {
      id: '3',
      title: 'System Strengthening Specialist',
      location: 'Addis Ababa, Ethiopia',
      country: 'Ethiopia',
      posted: 'Posted 1 week ago',
      description: 'Lead health system strengthening projects focused on improving healthcare infrastructure, workforce development, and supply chain resilience. Design and implement interventions to enhance service delivery, monitor health indicators, and build sustainable healthcare capacity.',
      employmentType: 'Full-time',
      level: 'Mid-Level',
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl leading-relaxed mb-12">
              Shape the future of healthcare across Africa. Our health systems advisors strengthen 
              healthcare infrastructure, develop policies, and build sustainable systems that improve 
