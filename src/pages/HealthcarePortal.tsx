              ...
              >
                ...
                <div className="p-6 sm:p-8 flex flex-col flex-grow">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => tier.name === 'Guest Access' ? window.open('https://pacem-market-access-production.up.railway.app/portal', '_blank') : tier.name === 'Registered Customer' ? setShowRegisterForm(true) : tier.name === 'Verified Partner' ? setShowContactSales(true) : undefined}
